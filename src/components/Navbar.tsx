...
// Using standard CSS classes to avoid dependency on Next.js specific modules
import './Navbar.css';
...
const Navbar: React.FC<NavbarProps> = ({ username, onRefresh }) => {
  ...
  return (
    <nav className="w-full h-[76.19px] z-[500] px-[16px] py-[5px] bg-[#007a33] fixed top-0 left-0 right-0 shadow-lg">
      {/* Brand Identity Section - Replicating Map of Pi Header Logic */}
      <div className="w-full flex justify-between items-center mb-1">
        ...
        <div className="flex-1 flex justify-end">
           {/* Placeholder for Membership icon style */}
      ...
      {/* Navigation Icons Section - Matches Navbar.module.css styles */}
      <div className="flex justify-between items-center px-2">
        <div className="nav-item cursor-pointer text-white opacity-40">
           <svg size={26} fill="none" stroke="currentColor" viewBox="0 0 24 24" className="w-6 h-6">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M10 19l-7-7m0 0l7-7m-7 7h18" />
           </svg>
        </div>

        <div className="nav-item cursor-pointer text-[#ffd700]" onClick={onRefresh}>
          <svg size={24} fill="none" stroke="currentColor" viewBox="0 0 24 24" className="w-6 h-6">
        ...
        <div className="nav-item cursor-pointer text-[#ffd700] relative">
          <svg size={24} fill="none" stroke="currentColor" viewBox="0 0 24 24" className="w-6 h-6 text-white opacity-80">
